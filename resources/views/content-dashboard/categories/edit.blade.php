...
@section('content')
    @include('layouts.overview',['text' => 'Edit Kategori', 'icon' => 'mdi-bookmark'])
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                      <form class="forms-sample" action="{{route('category.update',['id' => $id])}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                          <label for="category_name">Kategori <sup style="color:red">*</sup></label>
                          <input type="text" class="form-control" id="category_name" placeholder="Masukkan kategori menu..." name="category_name" value="{{ $category->name }}" required>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".dropzone").dropzone({
                ...
                url: "{{ route('category.store-image') }}",
                headers: {
