...
@section('content')
    @include('layouts.overview',['text' => 'Tambah Kategori', 'icon' => 'mdi-bookmark'])
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                      <form class="forms-sample" action="{{route('category.store')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="form-group">
                          <label for="category_name">Kategori <sup style="color:red">*</sup></label>
                          <input type="text" class="form-control" id="category_name" placeholder="Masukkan kategori menu..." name="category_name" value="{{ old('category_name') }}" required>
                        </div>
                        <div class="form-group">
