...
@section('content')
    @include('layouts.overview',['text' => 'Tambah Slider', 'icon' => 'mdi mdi-file-image'])
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                      <form class="forms-sample" action="{{route('slider.store')}}" enctype="multipart/form-data" method="POST">
                        @csrf
